...
In contrast to the plain `terraform_google_cloud_router` resource this module has better features.
...
[releases-github]: https://github.com/mineiros-io/terraform-googlr-cloud-router/releases
...
[variables.tf]: https://github.com/mineiros-io/terraform-google-cloud-router/blob/variables.tf
<!-- [examples/]: https://github.com/mineiros-io/terraform-google-cloud-router/blob/examples -->
